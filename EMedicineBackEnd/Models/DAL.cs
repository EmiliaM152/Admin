    ...
    public class DAL
    {
        public Response register(Users users, SqlConnection connection)
        {
            ...
            if (i > 0)
            {
                ...
                response.StatusMessage = "Usuario registrado exitosamente";
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "Fallo en el registro del usuario";
            }
            return response;
        }
        /*public Response updateFund(Users users, SqlConnection connection)
        {
            ...
            {
                response.StatusCode = 200;
                response.StatusMessage = "Fondos actualizados exitosamente";
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "Ocurrió un error. Intente de nuevo más tarde.";
            }
            return response;
        }*/
        ...
        public Response login(Users users, SqlConnection connection)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                response.StatusCode = 200;
                response.StatusMessage = "Usuario válido";
            ...
            {
                response.StatusCode = 100;
                response.StatusMessage = "Usuario no válido";
        ...
        public Response viewUser(Users users, SqlConnection connection)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                response.StatusCode = 200;
                response.StatusMessage = "El usuario existe.";
                response.usuario = usuario;
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "El usuario no existe.";
                response.usuario = null;
            }
            return response;
        }
        public Response updateProfile(Users users, SqlConnection connection)
        {
            ...
            {
                response.StatusCode = 200;
                response.StatusMessage = "Registro actualizado exitosamente";
            }
            else
            {
                response.StatusCode = 100;
        ...
        public Response removeFromCart(Cart cart, SqlConnection connection)
        {
            ...
            {
                response.StatusCode = 200;
                response.StatusMessage = "Ítem eliminado exitosamente";
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "No se pudo eliminar el ítem";
            }
            return response;
        }
        public Response cartList(Cart cart, SqlConnection connection)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    response.StatusCode = 200;
                    response.StatusMessage = "Detalles del carrito obtenidos";
                    response.listaCarrito = listaCarrito;
                }
                else
                {
                    response.StatusCode = 100;
                    response.StatusMessage = "Los detalles del carrito no están disponibles";
                    response.listaCarrito = null;
                }
            }
            else
            {
        ...
        public Response placeOrder(Users users, SqlConnection connection)
        {
            ...
            {
                response.StatusCode = 200;
                response.StatusMessage = "El pedido se ha realizado exitosamente";
            }
            else
            {
                response.StatusCode = 100;
                response.StatusMessage = "No se pudo realizar el pedido";
            }
            return response;
        }
            ...
            public Response orderList(Users users, SqlConnection connection)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    response.StatusCode = 200;
                    response.StatusMessage = "Detalles del pedido obtenidos";
                    response.listaPedidos = listaPedidos;
                }
                else
                {
                    response.StatusCode = 100;
                    response.StatusMessage = "Los detalles del pedido no están disponibles";
                    response.listaPedidos = null;
                }
            }
            else
            {
        ...
        public Response addUpdateMedicine(Medicines medicines, SqlConnection connection)
        {
            ...
            if (medicines.Type != "Get" && medicines.Type != "GetByID")
            {
                ...
                {
                    response.StatusCode = 200;
                    if (medicines.Type == "Agregar")
                        response.StatusMessage = "Medicamento insertado exitosamente";
                    if (medicines.Type == "Actualizar")
                        response.StatusMessage = "Medicamento actualizado exitosamente";
                    if (medicines.Type == "Eliminar")
                        response.StatusMessage = "Medicamento eliminado exitosamente";
                }
                else
                {
                    response.StatusCode = 100;
                    if (medicines.Type == "Agregar")
                        response.StatusMessage = "El medicamento no se pudo guardar. Intente de nuevo.";
                    if (medicines.Type == "Actualizar")
                        response.StatusMessage = "El medicamento no se pudo actualizar. Intente de nuevo.";
                    if (medicines.Type == "Eliminar")
                        response.StatusMessage = "El medicamento no se pudo eliminar. Intente de nuevo.";
                }
        ...
        public Response userList(SqlConnection connection)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    response.StatusCode = 100;
                    response.StatusMessage = "No Exito";
