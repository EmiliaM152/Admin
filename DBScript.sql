USE [master]
GO
/****** Object:  Database [EMedicine] *****/
CREATE DATABASE [EMedicines]
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_AddUpdateMedicine] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT INTO [dbo].[Users] (FirstName, LastName, Password, Email, Fund, Type, Status, CreatedOn)
VALUES ('Admin', 'Admin', 'adminpassword', 'admin@example.com', 0.00, 'Admin', 1, GETDATE());
